...
const XMarkSVG = (props) => {
    return (
        <div>
            <svg className="DeleteSentence" onClick={props.onclick} 
            ...
            <path d="M336.559 68.611L231.016 174.165l105.543 105.549c15.699 15.705 15.699 
				...
				0-56.85l105.54-105.549L11.774 68.611c-15.699-15.699-15.699-41.145 0-56.844 
				15.696-15.687 41.127-15.687 56.829 0l105.563 105.554L279.721 
